...
​	海明(hamming)码：纠错d位，需要码距2d+1的编码方案；检错d位，只需要码距为d+1
...
- 交换机：实际就是一个多端口网桥。通过自学习，获知到达主机的接口信息。学习得到的表叫交换表
  - 直通交换：帧在接收后只检查目的地址，几乎能马上转发出去
...
![image-20200820145826781](images\image-20200820145826781.png)